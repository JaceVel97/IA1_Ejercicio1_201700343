...
function initial(states){
  ...
  test(states, counter_case)

}

function test(states, counter_case){
  ...
  time = setTimeout(function(){ test(states, counter_case); analyze_case(counter_case);}, 1500);
}
